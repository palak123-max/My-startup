...
export const faqs = [
  {
    ...
    answer:
      "Any multi-step task that involves reading information from one place and acting in another — routing leads, triaging tickets, updating records, sending follow-ups, compiling reports. If you can explain the steps to a new team member, Cadence can typically run them.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You control how much autonomy each workflow has. Sensitive actions — sending an external email, changing a billing record — can require your approval before they run. Every action is logged with the reasoning behind it, so mistakes are easy to catch and fix.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Data is encrypted in transit and at rest. Access to each connected tool is scoped to only what a given workflow needs, and you can revoke a connection at any time. Enterprise plans support custom data retention and private deployment.",
  },
  {
...
export const founder = {
  name: "Palak Bubna",
  role: "Founder & CEO",
  bio: "Palak founded Cadence AI after spending too many hours watching operations teams do brilliant work slowed down by repetitive, manual busywork. She leads product and design, with a focus on building automation that people actually trust — because it explains itself.",
